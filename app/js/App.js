...
var BlogScroll = function () {
  function BlogScroll() {
    _classCallCheck(this, BlogScroll);

    // cache elements from page
    this.wind = (0, _jquery2.default)(window);
    this.sidebar = (0, _jquery2.default)('.blog__menu');

    this.events();
  }

  _createClass(BlogScroll, [{
    key: 'events',
...
var _ToggleMenu = __webpack_require__(6);
...
var _BlogScroll = __webpack_require__(2);

var _BlogScroll2 = _interopRequireDefault(_BlogScroll);
